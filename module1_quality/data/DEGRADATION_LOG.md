...
| `vignette_08_test.png` | `08_test.png` | vignette | radial darkening: gain = clip(1.15 - 0.95*(r/rmax)^2, 0.15, 1.0) |
...
| `overexp_19_test.png` | `19_test.png` | overexp | exposure raised: pixel*2.2 + 40, then clipped to 255 |
